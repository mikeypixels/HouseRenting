    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_LOGIN) {
            ...
            if (resultCode == RESULT_OK) {
                if (!FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber().isEmpty()) {
                    startActivity(new Intent(this, Upload.class).putExtra("Phone", FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber()));
                    finish();
...
//                    Toast.makeText(this, "Cancelled", Toast.LENGTH_SHORT).show();
                    ...
                    if (response.getErrorCode() == ErrorCodes.NO_NETWORK) {
                        ...
                        //SweetDialog
                        SweetAlertDialog waitingDialog = new SweetAlertDialog(RegisterActivity.this, SweetAlertDialog.ERROR_TYPE);
    ...
    public void onBackPressed() {
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(RegisterActivity.this, SiginAs.class));
                finish();
            }
        });
